...
namespace OD01 {
    ...
    function char(c: string, col: number, row: number, color: number = 1) {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            higher_byte = (_screen[ind + i] & 0x80) | ((_screen[ind + i] & 0x80) >> 1) | (_screen[ind + i] & 0x40) | ((_screen[ind + i] & 0x40) >> 1) | (_screen[ind + i] & 0x20) | ((_screen[ind + i] & 0x20) >> 1) | (_screen[ind + i] & 0x10) | ((_screen[ind + i] & 0x10) >> 1)
            lower_byte = (_screen[ind + i] & 0x08) | ((_screen[ind + i] & 0x08) >> 1) | (_screen[ind + i] & 0x04) | ((_screen[ind + i] & 0x04) >> 1) | (_screen[ind + i] & 0x02) | ((_screen[ind + i] & 0x02) >> 1) | (_screen[ind + i] & 0x01) | ((_screen[ind + i] & 0x01) >> 1)
